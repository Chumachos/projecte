...
![journalctl format json-pretty](/img/journalctl-format-jsonpretty1.png)

![journalctl format json-pretty](/img/journalctl-format-jsonpretty2.png)

* json-sse: entrades amb estructures de tipus JSON, però en un format adequat per a ser un missatge enviat per servidors	

![journalctl format json-sse](/img/journalctl-format-json-sse.png.png)

* cat: mostra només el missatge, sense cap altre tipus d'informació (com hora, host...)

![journalctl format cat](/img/journalctl-format-json-cat.png)
